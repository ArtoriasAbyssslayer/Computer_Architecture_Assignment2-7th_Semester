...
**Best Deal**
* specbzip
Οσον αφορά αυτό το benchmark μπορούμε να δουμε το case C οπου εχουμε 1MB L2_size και μέσο cpi 1.55 (+0.01 από το best case D1) και χαμηλότερο associativity έχει κόστος 
  * cost = 368 
...
#### Παρατηρήσεις
* Βλέποντας τα best deals για κάθε  περίπτωση παρατηρούμε οτι καθοριστικό ρόλο στην απόδoση παίζει κυρίως το cache line size  και όχι τα υπόλοιπα στοιχεία (το οποίο το είχα παρατηρήσει εξ'αρχής). Έτσι επιλέγουμε σε κάθε αρχιτκτονική να χρησιμοποιήσουμε τα ελάχιστα δυνατά μεγέθη μνημών(που είναι και τα πιο ακριβά) θυσιάζοντας μια μικρή βελτίωση στο cpi της τάξης του 0.001(αναλυτικά πάνω).
