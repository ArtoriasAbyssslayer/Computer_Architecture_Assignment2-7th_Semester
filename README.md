...
Από το αρχείο [stats.txt](https://github.com/harryfilis/Computer_Architecture_Assignment2-7th_Semester/blob/master/spec_results/specsjeng/stats.txt):</br>
  ...
  **3)Benchmarks cpu_clock = 2Ghz, 1Ghz**
  ...
  Το default system.cpu_clk_domain δηλαδή το ρολόι χρονισμού της CPU είναι 500 ή 2 GHz, επομένως τώρα τρέχουμε για 1 GHz και για 2Ghz. Το ρολόι αυτό ρυθμίζει το ρολόι του CPU και των μονάδων επεξεργασίας του, δηλαδή των L1 Data και Instruction cache, της L2 cache.</br>
